...
describe('v2 integration: USB -> LAN -> Firebase transport failover for one physical device', () => {
  it('falls back from USB to LAN to Firebase as each transport fails, and Firebase only ever receives an encrypted envelope', async () => {
    ...
    registry.observeEndpoint({ deviceId: 'huawei-1', verified: true, endpoint: { endpointId: 'usb-1', type: 'usb', serial: 'L2N4C19515006599' } });
    registry.observeEndpoint({ deviceId: 'huawei-1', verified: true, endpoint: { endpointId: 'lan-1', type: 'lan', serial: 'L2N4C19515006599' } });
    registry.observeEndpoint({ deviceId: 'huawei-1', verified: true, endpoint: { endpointId: 'firebase-1', type: 'firebase', serial: 'L2N4C19515006599' } });
