...
- le Huawei `MAR-LX1A`, numéro de série `L2N4C19515006599`, reste physiquement près du PC et porte la passerelle Mina pour Telegram, SMS et transports locaux ;
...
2. exécuter `adb -s L2N4C19515006599 tcpip 5555` ;
...
```text
physicalDeviceId: huawei:L2N4C19515006599
usbEndpoint: L2N4C19515006599
