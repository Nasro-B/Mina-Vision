...
- proof cloud read-only: avec `mina.vision.ai@gmail.com` et le projet gcloud `mina-vision`, Firestore `(default)` est `FIRESTORE_NATIVE` en `eur3`. La release distante `cloud.firestore` référence le ruleset `86199dee-794e-4a50-ab29-6e611986953f` (mise à jour `2026-07-23T04:00:56.501669Z`); son SHA-256 est `D30C513950ACB498B4608A7AB6F529F216551F92045608ECE9F02A367B74BEFF`, contre `F2F50EF6986418AD4D72C1547E6D7DA48F88B70434BA34BFF620529E29AEE67D` localement. La liste Cloud Storage est vide et la release `firebase.storage` répond `404`. Le compte de service existant correct est `firebase-adminsdk-fbsvc@mina-vision.iam.gserviceaccount.com` (`firebase-adminsdk`).
