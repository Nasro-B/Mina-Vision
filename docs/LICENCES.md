...
- `espeak-ng@1.0.2` est sous **GPL-3.0-or-later** ; le projet est déclaré ISC dans package.json.
...
## 3. Vulnérabilités npm audit — atteignabilité et décisions (2026-07-22)

12 avis (7 moderate, 5 high, 0 critical), tous **transitifs ou sans correctif publié**
(`fixAvailable: false` sauf mention). Aucune promesse `npm audit fix` automatique — décision
par chemin d'atteignabilité :
...
Re-vérification : `npm audit --json` à chaque vague de release (gate Wave 4).
