...
- **Vérifier le nom d'utilisateur des commits** : l'historique porte `Nasro <mina.vision.ai@gmail.com>`. Si tu ne veux pas exposer cette adresse publiquement, configure une adresse GitHub `noreply` **avant** le premier push.
