...
| [docs/guides/lm-studio.fr.md](docs/guides/lm-studio.fr.md) | Modèles locaux (texte, vision, embeddings) via LM Studio |
| [docs/guides/sandbox-runtimes.fr.md](docs/guides/sandbox-runtimes.fr.md) | Débloquer le bac à sable Windows (runtimes Python/Node/PowerShell) |
| [docs/guides/face-model.fr.md](docs/guides/face-model.fr.md) | Reconnaissance faciale locale : provisionner un modèle ONNX |
| [docs/operations/TELEGRAM.fr.md](docs/operations/TELEGRAM.fr.md) | Canal Telegram (conversation et commandes) |
| [docs/operations/FIREBASE.fr.md](docs/operations/FIREBASE.fr.md) | Sauvegarde chiffrée et relais Firebase |
| [docs/operations/ANDROID-HUAWEI.fr.md](docs/operations/ANDROID-HUAWEI.fr.md) | Téléphone Android : appairage, caméra, SMS |
