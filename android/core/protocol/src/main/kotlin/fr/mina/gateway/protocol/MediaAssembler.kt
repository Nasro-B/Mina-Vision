...
object MediaAssembler {
    ...
    private val ALLOWED_MIMES = setOf("image/jpeg", "image/png", "image/webp", "audio/mp4")
    ...
    fun parseMeta(meta: Map<String, Any?>): Meta {
        ...
        if (sizeBytes < 1 || sizeBytes > MAX_TOTAL_BYTES) throw IllegalArgumentException("media_taille_invalide")
        ...
        if (chunkBytes < 1 || chunkBytes > MAX_CHUNK_BYTES) throw IllegalArgumentException("media_chunk_bytes_invalide")
