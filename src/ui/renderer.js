...
const settingValue = (key, state) => {
  ...
  const values = {
    ...
    LM_STUDIO_VISION_ENABLED: providers.lmStudio.visionEnabled,
...
const refreshSettings = async () => {
  ...
  const SETTINGS_LABELS = {
    ...
    LM_STUDIO_VISION_ENABLED: { label: 'Activer la vision locale prouvée', help: 'À activer seulement après une sonde image locale réussie avec ce modèle.' },
