...
function createPreloadApi(ipcRenderer) {
  ...
  return Object.freeze({
    ...
    readProfiles: () => ipcRenderer.invoke('profile.read'),
    upsertProfile: (input) => ipcRenderer.invoke('profile.upsert', input),
    setActiveProfile: (profileId) => ipcRenderer.invoke('profile.setActive', { profileId }),
    completeWelcome: () => ipcRenderer.invoke('profile.completeWelcome'),
    ...
    analyzeVisionFile: (request) => ipcRenderer.invoke('mina:vision:analyze-file', request),
    ...
    documents: Object.freeze({
      ...
      cancel: (documentId) => ipcRenderer.invoke('mina:documents:cancel-parse', documentId),
      ...
      convert: (request) => ipcRenderer.invoke('mina:documents:convert', request),
