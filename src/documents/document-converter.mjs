...
export function createDocumentConverter({ sandboxRunner, fileWriter, clock } = {}) {
  if (!sandboxRunner?.run) throw new TypeError('document_converter_sandbox_runner_required');
